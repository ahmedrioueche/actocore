...
import { BarChart3, BookOpen, FileText, KeyRound, Map, Zap } from "lucide-react";
  ...
  const setupItems = useMemo(
    () =>
      [
        ...
        canReadActions
          ? {
              key: "appPages" as const,
              to: "/projects/$projectId/layout",
              icon: Map,
              titleKey: "nav.project.layout",
              descriptionKey: "projectOverview.setup.layout",
              complete: counts.appPages > 0,
            }
          : null,
