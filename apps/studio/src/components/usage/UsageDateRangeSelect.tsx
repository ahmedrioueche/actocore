...
export function UsageDateRangeSelect({
  ...
  const options = useMemo(
    () =>
      [
        { value: '7d' as const, label: t('usage.dateRange.7d') },
        { value: '30d' as const, label: t('usage.dateRange.30d') },
        { value: 'month' as const, label: t('usage.dateRange.month') },
