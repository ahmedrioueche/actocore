/**
 * Reusable UI state blocks (inline / section scope).
...
export { default as ErrorState } from '@/components/ui/Error';
export { default as ErrorScreen } from '@/components/ui/ErrorSection';
export { default as NotFoundState } from '@/components/ui/NotFound';
