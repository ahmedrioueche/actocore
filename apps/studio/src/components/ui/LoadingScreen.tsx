...
const LoadingScreen: React.FC<LoadingScreenProps> = ({
  ...
  return (
    <div
      className={`bg-background text-text-primary min-h-screen flex flex-col items-center justify-center px-4 transition-colors duration-500 overflow-hidden relative `}
    >
      {isOuter && (
