...
"""
"""
 python watch_package.py --watch packages/shared/package.json --dependency @ahmedrioueche/actocore-shared --targets  apps/studio/package.json apps/backend/package.json packages/sdk/package.json
"""
import json
import subprocess
import sys
...
Examples:
  ...
  python watch_package.py \\
    --watch ../packages/shared/package.json \\
    --dependency @ahmedrioueche/gympro-shared \\
